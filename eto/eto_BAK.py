...
def calc_ETo_PenmanMonteith(tmax, tmin, rs, rh, u2, doys, lat, elevation=0):
    ...
    csrs = {doy: fao.cs_rad(elevation, etr)
            for doy, etr in zip(range(1, 366), et_rad)}
